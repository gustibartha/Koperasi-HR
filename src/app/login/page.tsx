...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      try {
        const users: Record<string, { password: string; role: string; name: string; redirect: string }> = {
          ...
          "manajer@koperasi.com": { password: "manajer123", role: "manajer", name: "Manajer Operasional", redirect: "/approvals" },
        ...
        <form onSubmit={handleLogin}>
          ...
          <CardFooter className="flex flex-col gap-8 pt-10">
            ...
            <div className="text-center">
              <Link href="/" className="text-lg font-bold text-muted-foreground hover:text-foreground transition-all flex items-center justify-center gap-2">
