  ...
  return (
    <SidebarProvider className="bg-background">
      ...
      <SidebarInset className="bg-background">
        <header className="flex h-20 shrink-0 items-center gap-4 border-b border-border px-8 sticky top-0 z-50 bg-background/60 backdrop-blur-xl">
        ...
        <main className="flex flex-1 flex-col gap-6 p-8 md:p-14 relative overflow-hidden">
